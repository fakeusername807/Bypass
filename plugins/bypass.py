...
app = Client("bypass_bot", api_id=12345, api_hash="your_api_hash", bot_token="your_bot_token")
...
async def bypass_handler(_, message):
    ...
    raw_text = " ".join(message.command[1:])  # take all after /bypass
